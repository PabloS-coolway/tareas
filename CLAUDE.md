...
apps/web/src/ui/pages    Inicio · MisTareas · Equipo (/equipo/:userId, quién tiene qué por proyecto) · TodasTareas (/tareas, lista global con filtros) · Proyectos · Tablero (/p/:key) · Tarea (/t/:key) · Tokens · Usuarios · Roles
