...
@Module({
  controllers: [ProjectsController, SprintsController, TasksController, CommentsController, AttachmentsController],
  providers: [PrismaService, ActivityService, ProjectsService, SprintsService, TasksService, CommentsService, AttachmentsService, storageProvider],
  exports: [ProjectsService, SprintsService, TasksService, CommentsService, AttachmentsService, ActivityService],
})
